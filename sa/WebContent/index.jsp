...
<html>
    ...
    <body>
        ...
        %>
        <% if(pagename.equals("productlist")){ %> <%@include file="productlist.jsp" %>  <% }%>
        <% if(pagename.equals("account")){ %> <%@include file="account.jsp" %>  <% }%>
        <% if(pagename.equals("detailpage")){ %> <%@include file="detailpage.jsp" %>  <% }%>
        <% if(pagename.length() == 0){ %> <%@include file="home.jsp" %>  <% }%>
        <!--include page here-->
        ...
        <div class="footer">
            <div class="container">
                <div class="footer-top">
                    <div class="col-md-2 footer-left"><h3>About Us</h3></div>
                    <div class="col-md-2 footer-left"><h3>Your Account</h3></div>
                    <div class="col-md-2 footer-left"><h3>Shopping</h3></div>
                    <div class="col-md-2 footer-left "><h3>Categories</h3></div>
                    <div class="col-md-2 footer-left lost"><h3>Life Style</h3></div>
                    <div class="clearfix"> </div>
                </div>
