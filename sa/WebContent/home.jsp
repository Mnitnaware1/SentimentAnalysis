        ...
        <div class="banner-grids">
            <div class="col-md-6 jocket">
                ...
                <div class="jock-text">
                    ...
                    <a class="collection" href="detailpage.jsp">View collection <i class="glyphicon glyphicon-arrow-right"></i></a>
                </div>
                    ...
                    <div class="standard active" data-selector="1">
                        <div class="tag-grid">
                            <div class="tag-wrapper">		
                                <a href="detailpage.jsp"><img src="images/s2.jpg" class="img-responsive" alt="" /></a>
                                <div class="r-title">
                                    <h3>Sunny Dress</h3>
                                    <h4>$30</h4>
                                </div>
                            </div>
                            <div class="atc"><a href="detailpage.jsp">Shop</a></div>
                        </div>
                        <div class="tag-grid">
                            <div class="tag-wrapper">		
                                <a href="detailpage.jsp"><img src="images/s1.jpg" class="img-responsive" alt="" /></a>
                                <div class="atc"><a href="detailpage.jsp">Shop</a></div>
                                <div class="r-title">
                                    <h3>White Shirt</h3>
                                    <h4>$30</h4>
                        ...
                        <div class="tag-grid">
                            <div class="tag-wrapper">		
                                <a href="detailpage.jsp"><img src="images/s3.jpg" class="img-responsive" alt="" /></a>
                                <div class="atc"><a href="detailpage.jsp">Shop</a></div>
                                <div class="r-title">
                                    <h3>Puma Shoe</h3>
                                    <h4>$30</h4>
